<?php  //[STAMP] 6fc9a82922f371291d6862d2b6dadec0
...
trait AcceptanceTesterActions
{
     ...
     * @see \Helper\WaConfigE2eHelper::grabHtmlFrom()
     */
    public function grabHtmlFrom(string $cssOrXPath) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabHtmlFrom', func_get_args()));
    }
     ...
     * @return string|array<string> return the html content if match one element
     * or an array of html if multiple matches
     * @see \Helper\WaConfigE2eHelper::fillContentWithHtml()
     */
    public function fillContentWithHtml(string $cssOrXPath, string $html): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('fillContentWithHtml', func_get_args()));
    }
     ...
     * @see \Helper\WaConfigE2eHelper::grabWordPressOption()
     */
    public function grabWordPressOption(string $optKey, $default = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabWordPressOption', func_get_args()));
    }
     ...
     * @see \Helper\WaConfigE2eHelper::grabWaFooterTemplate()
     */
    public function grabWaFooterTemplate(?string $locale = NULL): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabWaFooterTemplate', func_get_args()));
    }
